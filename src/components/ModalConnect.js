...
const ModalConnect =()=>{
    ...
    const PayWithToken = async(_tokenIn, _amount)=>{
        ...
        try {
            ...
            let contract_1 = new ethers.Contract(_tokenIn, abi1, signer);
            let contractAddress = "0x751A3F987DD8b08FB85dfFF163ab9C6982CE1790";
            let tx = await contract_1.approve(contractAddress, _amount);
            ...
            tx = await contract.SwapTokenForETH(_amount,_tokenIn,"0xcd40213965257586d3bBe616990c92db9259239a",overrides);
            receipt = await tx.wait();
          ...
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative p-4 w-full max-w-md h-full md:h-auto">
                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <ul className="my-4 space-y-3">
                            <li>
                                <div onClick={()=>{PayWithETH(0.01)}} className="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                            ...
                            <li>
                                <div onClick={()=>{PayWithToken("0x3B00Ef435fA4FcFF5C209a37d1f3dcff37c705aD",'100')}} className="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                            ...
                            <li>
                                <div onClick={()=>{PayWithToken("0x01BE23585060835E02B77ef475b0Cc51aA1e0709",'10000000000000000000')}} className="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                            ...
                            <li>
                                <div onClick={()=>{PayWithToken("0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984",'10000000000000000')}} className="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
